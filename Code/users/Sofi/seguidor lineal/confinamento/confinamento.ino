...
umbral = 150; //umbral teporal




//  delay(500);
//  Serial.println("reading my enviroment, this may take a while");
//  delay(100);
//  
//  for (int l = 0; l <= 20; l++) {
//    ArcoDer(400);
//    Serial.println("reading brrrrrr: ");
//    Val = analogRead(sensorDerPin);
...
//bailecito de que termino de leer(???)
//GiroDer(400);
//GiroIzq(400);
//Avanza(400);
//Para();
...
//umbral = (ValNegro - ValBlco)/2+ValBlco  ;
//Serial.print("umbral ");
//Serial.println(umbral);
//
//delay(500);
//Serial.println("i'm done reading my enviroment!!");
...
void loop() {
  // 
  sensorDerValue = analogRead(sensorDerPin);

  sensorIzqValue = analogRead(sensorIzqPin);
...
if ((sensorIzqValue < umbral) and (sensorDerValue < umbral)){
Avanza(2);
...
if ( (sensorDerValue > umbral) and (sensorIzqValue < umbral) ){ 
ArcoIzq(2);
