...
///seguir avanzando en blanco hasta encontrar negro
...
if ((sensorIzqValue > 100) and (sensorDerValue > 100)){Serial.println("go");
Avanza(100);}

if ( (sensorIzqValue < 100)and (sensorDerValue > 100) ) { Serial.println ("turn right");
GiroDer(950);
Avanza(100);
}

if ( (sensorDerValue < 100) and (sensorIzqValue > 100) ){ Serial.println ("turn left");
GiroDer(950);
Avanza(100);
}

if((sensorIzqValue < 100) and (sensorDerValue < 100)){Serial.println("lost.");
delay(200);
Para();
}
